  ...
  return (
    <main className="min-h-screen bg-[#0d0d0d] text-[#e5e5e5] px-4 py-12">
      <div className="max-w-2xl mx-auto space-y-6 text-sm leading-relaxed">
        ...
        <p className="text-[#888]">Last updated: May 2026</p>
        ...
        <section className="space-y-2">
          ...
          <p>
            Source code is available under the MIT License. Key runtime dependencies include js-beautify
            (MIT) and Prism.js (MIT).
          </p>
        </section>
